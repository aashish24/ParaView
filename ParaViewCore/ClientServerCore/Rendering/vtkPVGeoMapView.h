...
=========================================================================*/
// .NAME vtkPVGeoMapView
// .SECTION Description
// vtkPVGeoMapView adopts vtkContextView so that it can be used in ParaView
// configurations.

#ifndef __vtkPVGeoMapView_h
...
private:
  vtkPVGeoMapView(const vtkPVGeoMapView&); // Not implemented
  void operator=(const vtkPVGeoMapView&); // Not implemented
